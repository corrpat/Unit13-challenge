...
def recommend_portfolio(intent_request):
    ...
    initial_recommendation = 
        if intent_request['riskLevel']= "none":
            return "100% bonds (AGG), 0% equities (SPY)"
        if intent_request['riskLevel']="very low":
            return "80% bonds (AGG), 20% equities (SPY)"
        if intent_request['riskLevel']="low":
            return "60% bonds (AGG), 40% equities (SPY)"
        if intent_request['riskLevel']="medium":
            return "40% bonds (AGG), 60% equities (SPY)"       
        if intent_request['riskLevel']="high":
            return "20% bonds (AGG), 80% equities (SPY)"
        if intent_request['riskLevel']="very high":
            return "00% bonds (AGG), 100% equities (SPY)"
